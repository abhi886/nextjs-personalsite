...
function About() {
  return (
    <section>
      <h1 className='font-bold text-2xl mt-4'>01. About Me </h1>
      ...
      <div className='grid grid-cols-1  md:grid-cols-2 space-x-4 my-6'>
        ...
        <div className='lg:pt-0'>
          <p className='text-justify tracking-wider'>
            ...
            <br /> React.js, Node.js, Express.js, MongoDB, npm, MySQL, HTML5
            &amp; CSS3, Docker, Babel, Git, Github, postman, Visual Studio Code{" "}
            <br />
            🌱 My future plans in learning: <br /> React Native, GatsbyJS,
            GraphQL, AWS Lambda, AWS Amplify, Google Cloud Platform, Kubernetes,
            Webpack <br />
            🌱 I have also worked using the following set of toolbox- Php, Code
