...
import { renderOptions } from ".././../../src/utils/contentfulUtils";

function BlogSlugPage({ title, readTime, imageUrl, description, updatedDate, language, goBackLink }) {
  return (
    <div className='mx-auto mt-10 px-4 pb-28 sm:mt-16 sm:px-6 md:px-8 xl:px-12 xl:max-w-6xl'>
      <main>
        <article className='relative pt-10 max-w-3xl mx-auto xl:max-w-none xl:grid xl:grid-cols-3 xl:gap-x-8'>
          ...
          { language && <p className='p-2 text-xs text-personal_blue-workBackground font-mono text-right'>
                {" "}
                {language &&
