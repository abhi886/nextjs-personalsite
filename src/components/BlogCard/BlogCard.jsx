...
function BlogCard({
  ...
  return (
    <article className='cursor-pointer group  hover:scale-105 transition duration-700 ease-in-out hover:shadow-md '>
      ...
      <div className='group-hover:px-2 hover:transition duration-700 ease-in-out group-hover:mb-6'>
        <a href='#'>
          <span className=' text-blue-600 inline-block mt-5 text-xs font-medium tracking-wider uppercase'>
            Javascript
          </span>
        </a>
        <div className='group overflow-hidden text-overflow:ellipsis h-16 line-clamp-2'>
