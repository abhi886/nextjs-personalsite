  ...
  return (
    <NavContainer>
      ...
      <div
        className={`'${
          isOpen
            ? 'translate-x-0 opacity-100 absolute inset-x-0 z-20 w-full py-4 transition-all duration-800 bg-gray-50 dark:bg-personal_blue md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center'
